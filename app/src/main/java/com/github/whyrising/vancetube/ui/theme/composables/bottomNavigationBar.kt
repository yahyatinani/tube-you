    ...
    modifier = modifier
      .drawBehind {
        drawLine(
          ...
          strokeWidth = 2.dp.roundToPx().toFloat()
        )
      }
  ) {
    Row(
...
// TODO: consider multiple lines of text here, not really supported by spec but we should have a better strategy than overlapping the icon and label
 ...
 */
private val BottomNavigationHeight = 46.dp
